...
export const INTRO_KEY = "introtext";
export const PRICE_KEY = "price";
export const DEPT_ID_KEY = "dept_id";
export const SUBDEPT_ID_KEY = "subdept_id";
export const SPEC_ID_KEY = "spec_id";
...
export const CAPTIONS_EXT = {
  [DESC_KEY]: "Описание",
  [SPEC_ID_KEY]: "Специалист",
  [INTRO_KEY]: "Специалист",
};
